...
extension MovieEndpoints: Endpoint {
    ...
    var path: String {
        ...
        case .searchDetailId:        return "/v1.4/movie/"
        ...
        case .searchMovieWithId:     return "/v1.4/movie"
        }
    }
    ...
    var body: [String : String]? {
        ...
        case .searchDetailId:         return .none
        ...
        case .searchMovieWithId:      return .none
        }
    }
    ...
    var item: [URLQueryItem]? {
        ...
        case .searchTitle:            return .none
        case .searchPerson:           return .none
        case .searchDetailId:         return [URLQueryItem(name: "limit", value: "10")]
